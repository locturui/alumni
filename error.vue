...
<template>
  <div class="bg-sad h-screen bg-cover flex flex-col items-center justify-center">
    <div class="flex flex-col items-center justify-center w-1/2 mx-auto">
      <h2 class="block font-bold max-w-fit p-2 text-4xl text-white font-montserrat">Ошибочка {{ error.statusCode }}</h2>
      <h3 class="block font-bold max-w-fit p-2 text-3xl  text-white font-montserrat">Извините мы этово не сделали :(</h3>
      <button
